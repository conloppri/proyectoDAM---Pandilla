                                ...
                                child: ListTile(
                                  ...
                                  subtitle: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      enabledBorder:
                                          AppStyles.outlineInputBorderRounded,
                                    ),
  ...
  saveInfo() async {
    ...
    if (saved) { //Si los cambios se han guardado correctamente
      ...
      navigator.pushReplacement(
        MaterialPageRoute(
          //vamos a la pantalla de visualización de perfil
