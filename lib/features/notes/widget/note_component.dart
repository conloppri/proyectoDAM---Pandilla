...
//Pantallas
import 'package:pandilla/features/notes/screens/note_view_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Card.filled(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: colors[widget.color]!, width: 1.5)
      ),
      color: colors[widget.color]!.withAlpha(160),
      child: Column(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Text(widget.author, style: AppStyles.blackBoldStyle, overflow: TextOverflow.ellipsis))
              ],
            ),
          ),
